...
def make_extension(host:str, port:int, username:str, password:str, scheme="http"):
    backgroud_js = read("files/proxy_extension/background.js") % (scheme, host, str(port), username, password)
